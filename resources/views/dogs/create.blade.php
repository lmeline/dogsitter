        ...
        <div class="flex flex-col sm:justify-center items-center mt-4 sm:pt-0 max-w-3xl mx-auto px-4 py-6">
            ...
            <form method="POST" action="{{ route('storeregisterdog') }}" class="overflow-y-auto px-6 py-4 bg-white dark:bg-gray-800 shadow-md sm:rounded-lg space-y-4">
                ...
                <div class="mt-4">
                    ...
                    <textarea id="comportement" name="comportement" rows="3" class="block mt-1 w-full border border-pink-300 focus:ring-pink-500 focus:border-pink-500 rounded-md" autocomplete="comportement">{{ old('comportement') }}</textarea>
                ...
                <div class="mt-4">
                    ...
                    <textarea id="besoins_speciaux" name="besoins_speciaux" rows="3" class="block mt-1 w-full border border-pink-300 focus:ring-pink-500 focus:border-pink-500 rounded-md" autocomplete="besoin_speciaux">{{ old('besoin_speciaux') }}</textarea>
                ...
                <div class="mt-4">
                    ...
                    <select id="sexe" name="sexe" class="block mt-1 w-full border border-red-300 focus:ring-red-500 focus:border-red-500 rounded-md" required>
                ...
                <div class="mt-6 flex justify-center">
                    <button type="submit" class="mx-4 px-4 py-2 bg-yellow-600 text-white font-semibold rounded-md shadow-md hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-200 ease-in-out">
                        {{ __('Register') }}
                    </button>
                </div>
            </form>
