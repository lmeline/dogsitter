    ...
    <div class="container mx-auto my-10 p-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach($abonnements_types as $index => $abonnement)
                <div
                    class="bg-gradient-to-r from-red-200 via-orange-200 via-pink-200 to-green-200 rounded-lg shadow-xl overflow-hidden flex flex-col">
                    ...
                    <div class="p-6">
                        <form method="POST" action="{{ route('chooseAbonnement') }}">
                            ...
                            <button type="submit"
                                class="bg-gradient-to-r from-yellow-300 to-pink-300 px-6 py-3 rounded-lg hover:from-yellow-400 hover:to-pink-400 transition w-full">
